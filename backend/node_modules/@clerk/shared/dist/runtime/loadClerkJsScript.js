...
const require_versionSelector = require('./versionSelector-CcTeYzoH.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	return `https://${buildScriptHost({
		...
		proxyUrl,
		domain
	})}/npm/@clerk/ui@${require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.1.0")}/dist/ui.browser.js`;
};
