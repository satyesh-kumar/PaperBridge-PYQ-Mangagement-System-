                        ...
                        <div className="flex items-center gap-3.5">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-indigo-200/90 mt-0.5">
                                    Join thousands of university students to access verified semester question papers instantly.
                                </p>
                            </div>
                        </div>
                        <button
                            ...
                            {filteredPapers.map((paper, index) => (
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-2 gap-2 pt-2">
                                        <button
                                            onClick={(e) => handlePreview(paper, e)}
                                            className="w-full flex items-center justify-center gap-1.5 py-2 px-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-xs font-semibold shadow-sm transition cursor-pointer"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="w-full flex items-center justify-center gap-1.5 py-2 px-3 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-xl text-xs font-semibold shadow-sm transition disabled:opacity-75 cursor-pointer"
                                        >
